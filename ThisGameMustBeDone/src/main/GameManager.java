...
public class GameManager implements Renderable {
	...
	/**
	 * Oyun içi çizilen öðeler belli özelliklerine göre(örn : dünya konumlarý
	 * durmadan güncelleniyor.) update edilir.
	 */
	@Override
	public void update() {
	...
	/**
	 * Çizilmesi istenilen öðeler {@code Renderer} sýnýfýndaki renderer metodunu
	 * dolaylý yoldan çaðýrarak çizim iþleminin yapýlmasýna olanak saðlayan
	 * metottur.
	 */
	@Override
	public void render() {
	...
	/**
	 * Program sonlandýðýnda silinmesi gereken objelerin silinmesini saðlayan
	 * metottur. Genellikle opengl ile oluþturulan objelerin silinmesi gerekir.
	 */
	@Override
	public void clean() {
