...
public class Bullet extends Entity{
	...
	protected Object clone() throws CloneNotSupportedException {
		Entity entity = new Bullet(this.mesh, texture.getClone(), new Vec2(this.position.x, this.position.y),this.rotation , new Vec2(this.scale.x , this.scale.y), this.worldPosition) ;
		return entity;
	}
